...
import { IconArrowRight, IconGithubLogo, IconPhone } from "@douyinfe/semi-icons";
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.cta}>
          ...
          <div className={styles.actions}>
            ...
            <Button size="large" icon={<IconPhone />} onClick={() => window.open(ANDROID_URL, "_blank", "noopener,noreferrer")}>{t.start.android}</Button>
